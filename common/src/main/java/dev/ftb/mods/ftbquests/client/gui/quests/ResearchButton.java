...
import dev.ftb.mods.ftbquests.client.gui.quests.chapter.ResearchChapterPanelView;
...
public class ResearchButton extends TabButton
{
    public ResearchButton(Panel panel)
    {
        super(panel, Component.empty(), Icons.MAP);
